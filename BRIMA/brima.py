...
def open_coordinates_window():
    ...
    coords_window.geometry("200x200")
...
brima.iconbitmap(r"C:\PROGRAMACAO\PYTHON\BRIMA\brima.ico")  # Use 'r' para cadeias de caracteres brutas
brima.title("Brima")
brima.geometry("200x250")  # Define o tamanho da janela (largura x altura)
brima.resizable(False, False)
...
version_label = tk.Label(frame, text="Versão 1.0\nSetor de Tecnologia Brima", bg='white', fg='black', font=("Helvetica", 4), anchor='center')
